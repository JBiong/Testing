        ...
        <div className="profileContainer">
          <Typography variant="h3" style={{ fontWeight: 'bold' }}>
            ...
            <div className="accountinfo">
              ...
              <Button style={{backgroundColor:'white', marginLeft:'25px', color:'#8C7111'}} onClick={() => setEditingEmail(!editingEmail)}>
              ...
              <Button
                style={{ backgroundColor: 'red', color: 'white', width: '300px', marginLeft: '700px', marginTop:'25px' }}
                onClick={deleteUser}
              >
                Delete Account
              </Button>
